...
export const Banking7Page: FC = () => {
  ...
  return (
    <PageTemplate
      title={t("nav.tree.synthesis")}
      prelude={
        fr ? (
          <>
            Le problème n'est pas une crise passagère ni de mauvaises décisions
            isolées, c'est la structure même du système monétaire. Une monnaie
            centralisée, facile à émettre et gérée sans véritable contre-pouvoir
            conduit mécaniquement à une érosion durable du pouvoir d'achat et à
            une mauvaise allocation des ressources.
          </>
        ) : (
          <>
            The problem is not a temporary crisis or isolated bad decisions —
            it's the very structure of the monetary system. A centralized
            currency, easy to issue and managed without real checks and balances,
            mechanically leads to a lasting erosion of purchasing power and a
    ...
    >
      ...
      <p>
        {fr ? (
          ...
          <>
            We saw that the money used daily (M2) is no longer a scarce
            resource backed by a real underlying asset, but{" "}
            <Emphasis>
              a scriptural currency created by commercial banks when granting
              loans
            </Emphasis>
            . This money creation operates within a regulatory and accounting
            framework, but it remains structurally expandable. In other words,
            money has become{" "}
      ...
      <p>
        {fr ? (
          <>
            ...
            <Emphasis>Quantitative Easing</Emphasis>. Ces interventions permettent
            de maintenir le système financier à court terme,{" "}
            <Emphasis>
          ...
          <>
            When this system shows signs of fragility, a central actor
            intervenes: the Central Bank. Without directly consulting savers or
            citizens, it has the power to increase base money (M0) in very large
            volumes, notably through asset purchase programs like{" "}
            <Emphasis>Quantitative Easing</Emphasis>. These interventions help
            maintain the financial system in the short term,{" "}
            <Emphasis>
              but at the cost of a gradual dilution of the existing money's
              value, when this expansion is not offset by equivalent real wealth
              creation.
            </Emphasis>
          </>
        )}
      ...
      <p>
        {fr ? (
          <>
            ...
            <Emphasis>Effet Cantillon</Emphasis>, l'argent nouvellement créé
            bénéficie d'abord aux acteurs les plus proches de sa source,
            principalement les marchés financiers et les détenteurs d'actifs. Il
            en résulte une inflation marquée des prix des actifs, notamment sur
            la bourse et l'immobilier, tandis que l'économie productive et les
            revenus du travail n'évoluent pas au même rythme,{" "}
            <Emphasis>accentuant les écarts de richesse</Emphasis>.
          </>
        ) : (
          <>
            This money creation does not affect the entire economy uniformly. As
            we saw with the <Emphasis>Cantillon Effect</Emphasis>, newly created
            money first benefits those closest to its source, mainly financial
            markets and asset holders. This results in marked asset price
            inflation, particularly in stocks and real estate, while the
      ...
      <p>
        {fr ? (
          <>
            ...
            biens et de services qui progresse plus lentement, exerce une
            pression inflationniste durable. Il ne s'agit pas simplement d'une
          ...
          <>
            Eventually, these imbalances spread to the real economy. A rapidly
            expanding money supply, facing production of goods and services that
            grows more slowly, exerts lasting inflationary pressure. This is not
            simply a one-time price increase, but{" "}
            <Emphasis>
              a gradual degradation of the value of money itself
            </Emphasis>
            .
          </>
        )}
        <Illustration
          ...
          alt={
            fr
              ? "Consumation des monnaies fiduciaires"
              : "Fiat currencies burning away"
          }
          width="30%"
          caption={
            fr
      ...
      <p>
        {fr ? (
          <>
            <Emphasis>Le constat est donc structurel</Emphasis>. Ces dynamiques ne
          ...
          <>
            <Emphasis>The diagnosis is therefore structural</Emphasis>. These
            dynamics are neither an accident nor isolated bad decisions. They
            stem from the{" "}
            <Emphasis>
              very functioning of a monetary system based on credit and debt
              expansion
            </Emphasis>
            . By trying to resolve short-term imbalances through ever-increasing
            money creation, the system tends to transfer the cost of these
            adjustments over time — and onto savers.
          </>
        )}
      </p>
      <p>
      ...
      <p>
        {fr ? (
          <>
            <Emphasis>Au fond, c'est quoi l'argent ?</Emphasis> Pourquoi un billet
          ...
          <>
            <Emphasis>What is money, really?</Emphasis> Why does a banknote have
            value while a tree leaf doesn't? Why did humanity use gold for
            millennia before turning away from it? To understand the solution, we
            must first redefine the basics.
          </>
        )}
      </p>
      <p>
