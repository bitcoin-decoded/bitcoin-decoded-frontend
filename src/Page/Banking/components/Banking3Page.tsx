...
import { Quiz, getQuizDataM0 } from "../../../Interactive";
  ...
  return (
    <PageTemplate
      ...
      prelude={
        fr ? (
          <>
            Pour faire face à une crise de liquidité majeure et ainsi rétablir
            la confiance, la Banque Centrale renfloue les banques commerciales en
            monnaie M0 en leur rachetant massivement des obligations.
          </>
        ) : (
          <>
            To face a major liquidity crisis and restore confidence, the Central
            Bank bails out commercial banks in M0 money by massively buying back
            their bonds.
          </>
        )
      }
    >
      <p>
        {fr ? (
          <>
            Nous avons vu deux grands principes :
            <ol>
              <li>
                L'essentiel de la monnaie en circulation (M2) est une promesse de
                remboursement.
              </li>
              <li>
                Les banques commerciales doivent absolument avoir assez de monnaie
          ...
          <>
            ...
            <ol>
              ...
              <li>
                Commercial banks absolutely must have enough reserve money (M0) to
                settle their accounts with each other.
              </li>
            </ol>
          </>
        )}
      ...
      <Callout
        title={
          fr
            ? "La monnaie de Banque Centrale : le pilier central de l'édifice économique"
            : "Central Bank money: the central pillar of the economic edifice"
        }
      >
        <p>
          {fr ? (
            <>
              ...
              <Emphasis>Et ça serait catastrophique.</Emphasis>
            </>
          ) : (
            <>
              If <i>Mr. WhoPays</i>'s Bank hadn't been able to pay its debt to{" "}
              <i>Ms. Michu</i>'s Bank, then it's possible that{" "}
              <i>Ms. Michu</i>'s bank in turn couldn't pay all its debts to
              other third-party banks, and so on. Through a domino effect, banks
              could become unable to honor their debts.{" "}
        ...
        <p>
          {fr ? (
            ...
            <>
              M0 money is the guarantee that M2 payments (which are promises) are
              indeed based on something real.{" "}
              <Emphasis>
                Without it, the entire payment system collapses because promises
      ...
      {isQuizSolved && (
        <>
            ...
            {fr ? (
              <>
                ...
                <ol>
                  ...
                  <DefaultSimulator />
                  <li>
                    Les autres banques voient le capital propre de la banque fondre
                  ...
                  <li>
                    ...
                    <Emphasis>tout le système est paralysé</Emphasis>.
                  </li>
                </ol>
              </>
            ) : (
              <>
                If several borrowers can no longer repay their loans within the
                same bank, here is the chain reaction:
                <ol>
                  <li>
                    The bank's claims decrease each time a loan is not repaid.
                  </li>
                  <li>
                    Equity decreases in turn, so the bank's balance sheet stays
                    balanced.
                  </li>
                  <DefaultSimulator />
                  <li>
                  ...
                  <li>
                    The bank no longer has access to M0 and can no longer settle
                    its debts with other banks:{" "}
                    <Emphasis>the entire system is paralyzed</Emphasis>.
                  </li>
                </ol>
              </>
            )}
          ...
          <p>
            {fr
              ? <>Face à un risque d'effondrement complet, la Banque Centrale sort son arme nucléaire monétaire pour sauver le système : le <i>Quantitative Easing</i>.</>
              : <>Facing the risk of total collapse, the Central Bank deploys its monetary nuclear weapon to save the system: <i>Quantitative Easing</i>.</>}
          </p>
          <Callout
            title={
              fr
          ...
          >
            ...
            <p>
              {fr ? (
                ...
                <>
                  And this is not science fiction: this "weapon" has been used
                  massively by all major central banks (Japan, United States,
                  Europe) after the <i>subprime crisis</i> of 2008 and during
                  the <i>pandemic crisis</i> of 2020.
                </>
              )}
            </p>
          </Callout>
          ...
          <p>
            {fr ? (
              ...
              <>
                We have FINALLY solved all monetary problems by printing M0 in
                abundance (what we call{" "}
                <i>running the printing press</i>).
              </>
            )}
          </p>
          <p>
            {fr
              ? "Vous vous doutez bien que tout cela est bien trop beau pour être vrai. Et vous avez raison : ces manoeuvres ont des conséquences considérables sur l'économie et qui sont le coeur du problème financier actuel. C'est ce que nous allons voir par la suite, vous tenez le bon cap !"
              : "You probably suspect all of this is too good to be true. And you're right: these maneuvers have considerable consequences on the economy and are the heart of the current financial problem. That's what we'll see next — you're on the right track!"}
          </p>
        </>
      )}
    </PageTemplate>
