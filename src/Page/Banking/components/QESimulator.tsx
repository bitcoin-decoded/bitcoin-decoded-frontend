      ...
      {isActive && (
        <p style={{ paddingLeft: "0.5rem", paddingRight: "0.5rem" }}>
          {fr ? (
            ...
            <>
              The Central Bank flooded the market to buy these securities. By
              driving the bond price up to €4,000, its annual yield (fixed at
              €40) mechanically collapses to 1%. This is how{" "}
              <strong>
                Quantitative Easing artificially crushes rates across the entire
                economy.
              </strong>
            </>
          )}
