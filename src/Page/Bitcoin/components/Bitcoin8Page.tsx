...
export const Bitcoin8Page: FC = () => {
  ...
  return (
    <PageTemplate title={t("nav.tree.walletsAndSeed")} showChapterNav={false}>
      <BlockReader chapterId={ROUTE_NAME.Bitcoin_8}>
        <Block>
          ...
          {({ markComplete }) => (
            <>
              <Callout title={fr ? "Une seed, un point de départ" : "A seed, a starting point"}>
                ...
                <p>
                  {fr
                    ? "Elle constitue la racine de tout le reste."
                ...
                <ol>
                  ...
                  <li>
                    {fr
                      ? "Et les UTXO arrivent sur ces adresses"
                      : "And the UTXOs land on those addresses"}
                  </li>
                </ol>
              </Callout>
              ...
              <SeedGenerator onComplete={markComplete} />
            </>
          )}
        </Block>
        ...
        <Block>
          ...
          >
            ...
            <ol>
              <li>
                {fr ? "Il dérive des clés à partir de la seed" : "It derives keys from the seed"}
              </li>
              <li>
                {fr
                  ? "Il génère les adresses correspondantes"
                  : "It generates the matching addresses"}
              </li>
              <li>
                {fr
          ...
          <p>
            {fr ? (
              <>
                ...
                <HighlightText>un montant</HighlightText>,{" "}
          ...
          <p>
            {fr ? (
              <>
                ...
                , <HighlightText>les clés</HighlightText>,{" "}
                <HighlightText>les adresses</HighlightText>, <HighlightText>les UTXO</HighlightText>{" "}
                et bien entendu <HighlightText>les signatures</HighlightText>.
              </>
            ) : (
              <>
                ...
                <HighlightText>the keys</HighlightText>,{" "}
                <HighlightText>the addresses</HighlightText>,{" "}
        ...
        <Block kind="tool">
          {({ markComplete }) => (
            <>
              ...
              <WalletDiscoveryGame onComplete={markComplete} />
            </>
          )}
        </Block>
