...
import { SynthesisQuiz, getQuizDataModule2Synthesis } from "../../../Interactive";
...
export const MoneyLaws5Page: FC = () => {
  ...
  return (
    <PageTemplate title={t("nav.tree.orangeSynthesis")}>
      <p>
        {fr
          ? "Tu viens de traverser un module dense et technique. Avant de prendre du recul, mets tes acquis à l'épreuve."
          : "You've just made it through a dense, technical module. Before stepping back, put what you've learned to the test."}
      </p>
      <p>
        {fr ? (
          <>
