      ...
      <p>
        {fr ? (
          <>
            ...
            <Reference to={ROUTE_NAME.MoneyLaws_4}>doctrine socialiste</Reference> s'effondre par
          ...
          <>
            ...
            <Reference to={ROUTE_NAME.MoneyLaws_4}>socialist doctrine</Reference> collapses from a
