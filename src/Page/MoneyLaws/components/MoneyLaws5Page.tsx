...
export const MoneyLaws5Page: FC = () => {
  ...
  return (
    <PageTemplate
      title={t("nav.tree.orangeSynthesis")}
      prelude={
        fr ? (
          <>
            La crise n'est pas un accident, mais la conséquence logique d'un système qui a sacrifié sa boussole. En utilisant une monnaie sans dureté, nous avons brisé le signal du prix du temps, condamnant l'économie à osciller entre des euphories artificielles et des purges douloureuses, tout en nous privant des outils de calcul indispensables à toute société complexe.
          </>
        ) : (
          <>
            A crisis is not an accident but the logical consequence of a system that sacrificed its compass. By using a currency without hardness, we broke the signal of the price of time, condemning the economy to swing between artificial euphoria and painful purges, while depriving ourselves of the calculation tools essential to any complex society.
          </>
        )
      }
    >
