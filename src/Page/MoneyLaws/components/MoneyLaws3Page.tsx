      ...
      <BlockReader chapterId={ROUTE_NAME.MoneyLaws_3}>
        <Block>
          <ChapterPrelude marginBottom="1.5rem">
            {fr ? (
              <>
                Pourquoi les crises économiques reviennent-elles toujours, malgré toutes les leçons
                du passé ? La réponse n'est pas dans la psychologie des marchés. Elle est dans la
                monnaie qu'on utilise.
              </>
            ) : (
              <>
          ...
          <Callout title={fr ? "La boussole truquée" : "The rigged compass"}>
            <ol>
              <li>
                {fr ? (
                  ...
                  <span>
                    ...
                    central ones through their policies) pin rates to the floor anyway. Steel,
                    bricks, time - none of it is sitting in reserve.
                  </span>
                )}
              </li>
              <li style={{ marginTop: "1rem" }}>
                {fr ? (
                  <span>
                    Le taux bas envoie pourtant le même message qu'avant :{" "}
                    <i>« Lancez vos projets »</i>. Sauf qu'il ment. La boussole dit « plein de
                    ressources », la réalité dit « les caisses sont vides ».
                  </span>
                ) : (
                  <span>
              ...
              <li style={{ marginTop: "1rem" }}>
                {fr ? (
                  ...
                  <span>
                    Fooled, entrepreneurs pile into projects that nothing supports: deserted
                    airports, empty towers, startups burning cash without producing a thing. This is{" "}
                    <Reference href="https://en.wikipedia.org/wiki/Malinvestment">
                      malinvestment
                    </Reference>
                    . And the gap widens between what we actually make and the numbers shooting up
                    on screens.
                  </span>
                )}
              </li>
        ...
        <Block>
          <p>
            {fr ? (
              <>
                ...
                on s'aperçoit que les ressources manquent pour terminer tous les chantiers. La bulle
                explose : les prix des matériaux s'envolent, les banques paniquent et arrêtent de
                prêter.{" "}
              </>
            ) : (
              <>
                Physical reality always catches up with the monetary lie. At some point, we realize
                that resources are missing to finish all the projects. The bubble bursts: material
          ...
          <p>
            {fr ? (
              <>
                Et vient ensuite la purge : ce qu'on appelle « crise » est en réalité un processus
                de <i>liquidation des erreurs</i>. C'est le moment où l'économie liquide les mauvais
                projets pour essayer de sauver ce qui peut l'être. La récession est une période de «
                ceinture serrée » obligatoire pour reconstituer l'épargne qu'on a fait semblant
          ...
          {({ markComplete }) => (
            ...
            >
              ...
              <p>
                {fr ? (
                  <>
                    ...
                    situation est stable, mais sa vie est un peu limitée. Il a alors une idée
                    brillante : construire un filet de pêche pour n'avoir plus qu'à travailler
                    quatre heures par jour.
                  </>
                ) : (
                  <>
                    Robinson fishes by hand eight hours a day. That gets him four fish - exactly
                    what he eats every day to feel full. His situation is stable, but his life is a
                    bit limited. Then he gets a brilliant idea: build a fishing net so he only has
              ...
              <p>
                {fr ? (
                  <>
                    Cependant, fabriquer ce filet prendra des jours entiers. Robinson sait que s'il
                    arrête de pêcher pour tresser son filet, il n'aura rien à manger.
                  </>
                ) : (
                  <>
                    However, making this net will take whole days. Robinson knows that if he stops
                    fishing to weave his net, he'll have nothing to eat.
                  </>
                )}
              </p>
              <Quiz {...getQuizDataRobinson(language)} onCorrectAnswer={markComplete} />
            </Callout>
          )}
        </Block>
            ...
            <li>
              {fr ? (
                ...
                <>
                  ...
                  during construction. Keynesians dispute this principle - but Robinson doesn't have
                  a central bank!
                </>
              )}
            </li>
        ...
        <Block last>
          <p>
            {fr ? (
              <>
                La cause des cycles économiques n'est pas extérieure. Ce ne sont pas des problèmes
                de « psychologie » des investisseurs. Au contraire, c'est un phénomène endogène,
                causé par la structure du système lui-même.{" "}
              </>
            ) : (
              <>
