...
// The non-modal backup reminder (CDC §7.6): a quiet card anchored to the bottom,
// dismissible, never trapping the reader. Lives outside the overlay and hides
// whenever the overlay is open, so the two never stack. Dumb: the decision of what
// (if anything) to show is the hook's.
export const AuthNotice: FC = () => {
  ...
  const cardStyle: CSSProperties = {
    ...
    borderTop: `2px solid ${getBrandGold(theme)}`,
