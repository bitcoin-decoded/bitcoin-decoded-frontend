const en = {
  ...
  "mempool.doubleSpend.suffix": "twice: once to Ms. Michu, once to Christine L.",
  ...
  "miningReward.subsidy": "Protocol subsidy",
  "miningReward.fees": "Total fees (full block)",
  "miningReward.feesPerTx": "fee",
  ...
  "txComparison.bankScenario": "Nicolas wants to transfer $1,000 to Ms. Michu.",
  ...
  "txComparison.btcScenario":
    "Nicolas wants to send 1.3 BTC to Ms. Michu. She holds two UTXOs (0.8 and 1 BTC).",
