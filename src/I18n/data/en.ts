const en = {
  ...
  "simulator.credit.title": "MR. WHOPAYS'S BANK BALANCE SHEET",
  "simulator.compensation.start": "Start compensation",
  "simulator.compensation.retry": "Retry",
  "simulator.compensation.title": "MR. WHOPAYS'S BANK BALANCE SHEET",
  "simulator.default.simulate": "Simulate a loan default worth a total of $15,000,000",
  ...
  "utxoBuilder.step1": "1. Select Alice's UTXOs",
  ...
  "utxoBuilder.change": "Change (Alice)",
  ...
  "signaturePlayground.privateKeyHint": "Used to produce a signature. Must never be shared.",
  ...
  "signaturePlayground.networkVerifies": "The node checks 3 inputs",
  ...
  "txComparison.bankScenario": "Alice wants to transfer €1,000 to Bob.",
  ...
  "txComparison.btcScenario":
    "Alice wants to send 1.3 BTC to Bob. She holds two UTXOs (0.8 and 1 BTC).",
  ...
  "nav.tree.moneyOrigin": "Where does money come from?",
  "nav.tree.twoLevels": "The two levels of money",
  "nav.tree.qe": "Quantitative Easing",
  "nav.tree.brokenEngine": "The broken engine",
  "nav.tree.cantillon": "The Cantillon Effect",
  "nav.tree.inflation": "Inflation",
  "nav.tree.synthesis": "In summary",
  "nav.tree.moneyLaws": "Why does the system fail?",
  "nav.tree.whatIsMoney": "What is money?",
  "nav.tree.economicCycles": "Economic cycles",
