const fr = {
  ...
  "utxoBuilder.newUtxoRecipient": "Nouvelle pièce pour le destinataire",
  "utxoBuilder.newUtxoNicolas": "Nouvelle pièce pour Nicolas",
  "utxoBuilder.recipientDesc": "Ce que Mme Michu reçoit",
  "utxoBuilder.changeDesc": "Monnaie rendue (entrées - montant - frais)",
  "utxoBuilder.feesImplicit": "Frais implicites pour le mineur",
  ...
  "signaturePlayground.parcoursDerive": "Calcul de la clé publique",
  "signaturePlayground.parcoursSign": "Signature du message",
  "signaturePlayground.parcoursVerify": "Vérification par le réseau",
  "signaturePlayground.parcoursConcordant": "concordante",
  "signaturePlayground.parcoursNotConcordant": "non concordante",
  "signaturePlayground.parcoursOriginalKey": "clé originelle",
  "signaturePlayground.parcoursModifiedKey": "clé modifiée",
  "signaturePlayground.privateKeyLabel": "Clé privée de Nicolas",
  "signaturePlayground.publicKeyLabel": "Clé publique de Nicolas",
  ...
  "home.hero.kicker": "Comprends l'argent avant de comprendre Bitcoin",
  ...
  "home.trust.sourced": "Chaque affirmation sourcée",
  "home.trust.openSource": "Open source",

  "home.rail.top": "Entrée",
  "home.rail.value": "La valeur",
  "home.rail.control": "Le contrôle",
  "home.rail.network": "Le réseau",
  "home.rail.final": "Le parcours",
