    ...
    answers: [
      {
        ...
        rationale: fr ? (
          ...
          <>
            Rejected! Sorry for Gyro... His project is brilliant, but too
            risky. With a tiny margin (remember the previous chapter),
            the bank cannot afford the slightest payment default.
      ...
      },
      {
        ...
        rationale: fr ? (
          ...
          <>
            Bingo! That's easy money. The loan is 100% secured by his
            existing stock portfolio (the pledge). If he doesn't pay,
            the bank sells his securities in one click. Risk = 0. File validated!
          </>
        ),
      },
      {
        text: fr
          ? "c) Mme Michu pour sûr !"
          : "c) Ms. Michu for sure!",
        isCorrect: false,
        rationale: fr ? (
          <>
