...
export const SEED_WORD_POOL: readonly string[] = [
  ...
  "amused", "anchor", "ancient", "anger", "angle", "angry", "animal",
  ...
  "autumn", "average", "avoid", "awake", "aware", "away", "awesome",
  "awful", "awkward", "axis", "balance", "bamboo", "banana", "banner",
  "bar", "barrel", "base", "basic", "basket", "battle", "beach", "bean",
