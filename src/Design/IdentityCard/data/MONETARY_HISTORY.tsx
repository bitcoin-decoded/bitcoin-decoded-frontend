  ...
  return [
    {
      ...
      history: fr
        ...
        : "In ancient Sumer, labor was paid with sacks of barley. Handy, you'd say... as long as the currency didn't get eaten by mice or rotted away in the rain!",
      imgSrc: grainOrge,
      characteristics: [
        {
          icon: <TimeIcon />,
    ...
    },
    {
      ...
      history: fr
        ...
        : "Salt — vital for eating and preserving food — also served as wages for Roman legionaries (salt, salary... yep, there's an etymological link 😉).",
      imgSrc: sel,
      characteristics: [
        {
          icon: <TimeIcon />,
    ...
    },
    {
      ...
      history: fr
        ...
        : "On the island of Yap, enormous limestone discs served as money. Their value came from how hard they were to carve and ship back across the sea.",
      imgSrc: pierreYap,
      characteristics: [
        {
          icon: <TimeIcon />,
      ...
      death: fr
        ...
        : "A foreign captain (David O'Keefe) showed up in the 19th century with iron tools and modern ships. What used to take years of extraction work suddenly became easy.",
    },
    {
      ...
      history: fr
        ...
        : "These small shells acted as money across Africa and Asia. Their scarcity came from their limited geographic spread and the natural difficulty of harvesting them.",
      imgSrc: cauris,
      characteristics: [
    ...
    },
    {
      ...
      death: fr
        ? "Il est peu pratique de payer son café avec de l'or : trop lourd, pas assez divisible, et difficile à auditer. C'est pourquoi, aujourd'hui, l'or n'est plus utilisé comme monnaie d'échange quotidien."
        : "Paying for your coffee in gold isn't exactly practical: too heavy, not divisible enough, and hard to audit. Which is why, today, gold is no longer used as everyday money.",
    },
    {
