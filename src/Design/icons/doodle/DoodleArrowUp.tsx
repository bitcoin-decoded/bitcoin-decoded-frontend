// Streamline Freehand — "upload-brackets" (CC BY 4.0, Streamline). Vendored via Iconify.
// An up-arrow framed by two brackets — used for the "Bloc précédent" nav button.
...
export const DoodleArrowUp = (props: Omit<DoodleIconProps, "inner" | "viewBox">) => (
